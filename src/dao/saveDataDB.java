...
public interface saveDataDB {
   ...
   void saveExamplesInfo(examples pp, String opType, List<subjElement> piList, List<contact> pcList, List<docList> dsl,List<docList> qrDsl,String userID) throws SQLException;
   void saveEmployeeInfo(person pp, String opType, List<subjElement> piList, List<contact> pcList, docList dd) throws SQLException;
   ...
   public void saveStrukturInfo(String opType,String orgID,String parentID,finalInfo pfList,List<address1> paList,List<contact> pcList)throws Exception;
